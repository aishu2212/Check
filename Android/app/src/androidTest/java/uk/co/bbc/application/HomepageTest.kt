...
import uk.co.bbc.application.utils.ComposeActions.performClickOnNodeWithTag
import uk.co.bbc.application.utils.ComposeActions.waitForLoadingSpinnerToDisappear
...
class HomepageTest {
    ...
    fun testHomePageLoadsAndDropdownMenuToggles() {
        // Scenario 1: Verify that the home page loads completely and essential elements are visible
        mainActivityScenario.use {
            ...
            // Verify the BBC logo is displayed and BBC broadcasting building image is displayed
            ComposeAssertions.assertNodeCountWithContentDescription(composeTestRule, "BBC Logo", 2) // Assert there are exactly 2 nodes of BBC image
    ...
    fun testDropdownMenuItemClick() {
        ...
        mainActivityScenario.use {
            ...
            // Verify dropdown is initially not displayed
    ...
    @Test
    fun testStayOnHomePageAfterChoosingYesInAlert() {
    ...
    fun testBreakingNewsButton() {
        ...
        mainActivityScenario.use {
            ...
            ComposeActions.performClickOnNodeWithText(composeTestRule, "Confirm")
            ComposeAssertions.isDisplayedWithText(composeTestRule, "My BBC")
        }
    }
}